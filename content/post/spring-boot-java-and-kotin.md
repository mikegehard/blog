...
draft: true
short: |
  Migrating a Java 8 Spring Boot application to Kotlin doesn't have to be an all or
  nothing endeavor. Java and Kotlin play well together.
title: "The Journey of a Spring Boot application from Java 8 to Kotlin, part 3: Configuration Classes"
---
Directory structure - separate dirs or the same dir?
sourceSets {
...
... and return to a traditional Java layout: com.bob.miraculous.accounts.Yay in src/com/bob/miraculous/accounts/Yay.java

Components that have Kotlin - how do you compile?

Java to Kotlin converter in IntelliJ
